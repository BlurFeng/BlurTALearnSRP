Shader "Custom/Chapter 14/Hatching"
{
    Properties
    {
		...
		_TileFactor ("Tile Factor", Float) = 1 //纹理平铺系数，值越大素描线越密
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target 
            {
				...
				fixed4 whiteColor = 
                fixed4(1, 1, 1, 1) 
                * (1 - i.hatchWeights0.x - i.hatchWeights0.y 
                - i.hatchWeights0.z - i.hatchWeights1.x 
                - i.hatchWeights1.y - i.hatchWeights1.z);
				
				fixed4 hatchColor = 
                hatchTex0 + hatchTex1 + hatchTex2 + hatchTex3 + 
